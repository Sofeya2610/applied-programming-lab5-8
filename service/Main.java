...
public class Main {
    public static void main(String[] args) {
        FlowerShop flowerShop = new FlowerShop(); // виконавець функцій,міститть основну логіку проги

        ConsoleMenu menu = new ConsoleMenu(flowerShop); // викликач менюшки,керує відображенням та виконанням команд
